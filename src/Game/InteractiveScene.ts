class InteractiveScene extends eui.Component implements eui.UIComponent{
    ...
    //放草
    private putgrass(){
        let PutGrass:PuticonEvent = new PuticonEvent(PuticonEvent.PUTINSECT);
    ...
    private puticon(treeUserId,type,PutType){
        let params = {	
			treeUserId:treeUserId,
            type:type
			};
        MyRequest._post("game/interaction",params,this,this.Req_puticon.bind(this,PutType),this.onGetIOError)
    }


    private Req_puticon(PutType,data):void{
		var Data = data;
